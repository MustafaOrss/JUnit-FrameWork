...
public class C03_TumSayfaScreenShot extends TestBase {
    ...
    public void test01() throws IOException {
        ...
        // Sonuclarin Nutella ecerdigini test edelim
        ...
        File tumeSayfaResim = new File("target/ekranResimleri/tumSayfaResim.png");

        File geciciResim = tss.getScreenshotAs(OutputType.FILE);

        FileUtils.copyFile(geciciResim,tumeSayfaResim);
