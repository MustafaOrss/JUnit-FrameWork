...
public class C02_switchingWindows extends TestBase {
    ...
    /*
        driver.switch.To().newWindow() kullanarak actigimiz
        window'a driver otomatik olarak gecer

        ANCAK!
        Biz newWindow() method'unu kullanmadan
        bir link tikladigimizda yeni window aciliyorsa driver eski window'da kalir
        Yeni window'a driver'i gecirebilmek icin yeni window'un WindowHandle Degerine ihtiyacimiz vardir
     */
    @Test
    public void test01() {
