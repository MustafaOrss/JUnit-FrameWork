...
public class C01_WebTables extends TestBase {
    ...
    public void test01() throws InterruptedException {
        ...
        // tum body'i tek element olarak locate etmek body icinde gecen bir metnin varligini
        ...
        System.out.println("===================");
        for (WebElement eachSatir: satirElementleriListesi
             ) {
        ...
        List<WebElement> besinciSutunDatalari = driver.findElements(By.xpath("//tbody/tr/td[5]"));
        for (WebElement eachBesinciSutun: besinciSutunDatalari
             ) {
