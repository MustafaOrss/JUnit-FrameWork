package day11_seleniumWait_webTable;
...
public class C01_SeleniumWaits {
    /*
        ...
        Implicitly wait sayfanin yuklenmesi ve her bir webelementin bulunmasi icin tanimlanan
        ...
        exception verip calismayi durdur

        Testlerin buyuk cogunlugunda implicitly wait suresi
        ...
        O goreve OZGU, TE SEFERLIK bir wait olusturabiliriz
    ...
    @Test
    public void expliticitlyWaitTesti(){
        ...
        1-test etmek isteddigmiz webelement zaten gorunuyorsa
        webelement'i locate yapip sonra ozel beklemeyi tanimlarim
        2-test etmek istedigimiz elementin ulasilabilir olmasi
            icin beklemek gerekiyorsa
            locatar'i verip bu lacatar ile bir element locate edene kadar
